...
train_bg_file = bg_folder + "bg_train_32b_300d_cased.pkl"
eval_bg_file = bg_folder + "bg_eval_32b_300d_cased.pkl"
...
model.compile(initial_lr=0.001)
model.train_and_evaluate(train_batch_generator, eval_batch_generator, evaluator, epochs=100, episodes=2)
