...
from pytorch_mrc.nn.layers import Embedding, Conv1DAndMaxPooling, Highway, VariationalDropout, PointerNetwork
...
class BiDAF(BaseModel):
    def __init__(self, vocab, device,
        ...
        # Output Layer
        self.pointer_net_layer = PointerNetwork(2 * rnn_hidden_size, 2 * rnn_hidden_size,
                                                hidden_dim=rnn_hidden_size, drop_prob=dropout_prob)
    ...
    def forward(self, data):
        ...
        start_logits, end_logits = self.pointer_net_layer(modeled_context, question_repr, context_mask, question_mask)
